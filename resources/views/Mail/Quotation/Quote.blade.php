...
<body>
    ...
    <div class="reportTitle">
        <h3 class="" style="text-align: center;">{{$email_data['title']}}</h3>
    </div>
    <br />
    <p>{{ $email_data['created_at']}}</p>
    <p>Hi, {{$email_data['userName']}}</p>
    <hr>
    ...
    <p>Pleasae indicate all prices,SHIPPING TERMS OF SALE, and indicate when your price quote shall expire. Our Contact
        Number : {{$email_data['number']}}</p>
    <hr>
    <p>Very truly yours,<br />
        {{ $email_data['created_user']}}</p>
