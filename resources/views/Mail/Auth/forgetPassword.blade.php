<div class="contain" style="background-color: white">
    <div class="mailboxCover">
        <div class="mailboxouter">
            ...
            line-height: 30px;
            /*text-align: left;*/
            color: #4f4f4f;">This is Your Password Reset Code!</h2>
            ...
            color: #4f4f4f;">Hi {{$email_data['name']}},</p>
                                ...
                                <div class="detailsboy p-2">
                                    <p style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif;
                                            ...
                                            line-height: 25px;
                                            text-align: left;
                                            color: #4f4f4f;">Reset your Password :<a
                                            href="http://127.0.0.1:8000/reset?passwordreset={{$email_data['remember_token']}}">Click
                                            here</a></p>
