        ...
        <div class="mailboxCover d-flex justify-content-center">
            <div class="mailboxouter" style="width: 40%; ">
                            ...
                            <td>
                                <div class="mailboxBody">
                                    <div class="topichere pt-2 center">
                                        ...
                                        <h2>your ticket has been updated by Our Team. </h2>
                                    </div>
                                    <div class="dearcus p-2">
                                        <p>Hi {{$email_data['name']}},</p>
                                    </div>
                                    <div class="detailsboy p-2">
                                        <p>We have replied to the support ticket you created. Please check it out.
                                        </p>
                                    </div>
                ...
                <div class="below-content " style="background-color: white">
                    ...
                    <p class="footeritemstext" style="text-align: center;">Alibaba.com Singapore Ecommerce Private
                        Limited,
