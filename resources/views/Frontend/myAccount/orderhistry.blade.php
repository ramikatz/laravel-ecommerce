    ...
    <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
            <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                ...
                </svg> <a href="">Supports Tickets</a></h6>
...
<div class="col-md-8">
    <div class=" bootdey">
        <div class="panel panel-default panel-order">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="pull-right"><label class="label label-primary">{{$order->status}}</label>
                                </div>
                                ...
                                <div class="">order made on: 05/31/2014 by <a href="#">Jane
                                        Doe </a></div>
                                <a data-placement="top" class="btn btn-danger btn-xs glyphicon glyphicon-trash" href="#"
                                    title="Danger"></a>
                                <a data-placement="top" class="btn btn-primary btn-xs glyphicon glyphicon-map-marker"
                                    href="{{route('frontend.tracking.show',$order->id)}} " title="primary"></a>
                                <br>
                                <hr>
                            </div>
            ...
            <div class="panel-footer">Put here some note for example: bootdey si a gallery
                of free bootstrap snippets
                bootdeys</div>
        </div>
    </div>
</div>
