                ...
                <div class="login_wrap">
                    <div class="padding_eight_all bg-white">
                        <div class="heading_s1">
                            <h3>Hi, {{$user->userName}}. Create New Password</h3>
                        </div>
                        <form action="{{route('dashboard.forget.reset.update',$user->id)}}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                <input type="text" required="" class="form-control" name="comfirm_password"
