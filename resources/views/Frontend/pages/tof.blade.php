...
<div class="main_content">
        <div class="container">
                ...
                <td align="left" style="box-sizing:border-box;padding-top:5px;text-align:center;padding:20px"><span
                                style="box-sizing:border-box;font-family:Helvetica,Arial;color:#767676;font-size:14px;font-weight:100;letter-spacing:0.3px;line-height:20px">
                                <p align="left" style="box-sizing:border-box"><strong style="box-sizing:border-box">

                                                <h1 style="text-align: center">TERMS OF SERVICE</h1>

                                        </strong><br style="box-sizing:border-box">
                                        <br style="box-sizing:border-box">
                                        <strong style="box-sizing:border-box">OVERVIEW <br
                                                        style="box-sizing:border-box">
                                        </strong><br style="box-sizing:border-box">
                                        This website is operated by sadfasdfsdfsd. Throughout the site, the terms "we",
                                        "us" and "our" refer
                                        <br style="box-sizing:border-box">
                                        to sadfasdfsdfsd. sadfasdfsdfsdoffers this website, including all information,
                                        tools and services
                                        available
                                        ...
                                        <br style="box-sizing:border-box">
                                        <br style="box-sizing:border-box">
                                        <em style="box-sizing:border-box">SECTION 1 - ONLINE STORE TERMS <br
                                                        style="box-sizing:border-box">
                                        </em>By agreeing to these Terms of Service, you represent that you are at least
                                        the age of majority
                                        in your
                                        state or shop_contact_province_state of residence, or that you are the age of
                                        majority in your state
                                        or
                                        shop_contact_province_state of residence and you have given us your consent to
                                        allow any of your
                                        minor
                                        ...
                                        <br style="box-sizing:border-box">
                                        <br style="box-sizing:border-box">
                                        <em style="box-sizing:border-box">SECTION 2 - GENERAL CONDITIONS <br
                                                        style="box-sizing:border-box">
                                        </em>We reserve the right to refuse service to anyone for any reason at any
                                        time.
                                        ...
                                        <br style="box-sizing:border-box">
                                        <br style="box-sizing:border-box">
                                        <em style="box-sizing:border-box">SECTION 3 - ACCURACY, COMPLETENESS AND
                                                TIMELINESS OF INFORMATION
                                                <br style="box-sizing:border-box">
                                        </em>We are not responsible if information made available on this site is not
                                        accurate, complete or
                                        current.
                                        The material on this site is provided for general information only and should
                                        not be relied upon or
                                        used as
                                        ...
                                        necessarily, is not
                                        current
                                        and is provided for your reference only. We reserve the right to modify the
                                        contents of this site at
                                        any
                                        time, but we have no obligation to update any information on our site. You agree
                                        that it is your
                                        ...
                                        <br style="box-sizing:border-box">
                                        <br style="box-sizing:border-box">
                                        <em style="box-sizing:border-box">SECTION 4 - MODIFICATIONS TO THE SERVICE AND
                                                PRICES <br style="box-sizing:border-box">
                                        </em>Prices for our products are subject to change without notice.
                                        ...
                                        <br style="box-sizing:border-box">
                                        <br style="box-sizing:border-box">
                                        <em style="box-sizing:border-box">SECTION 5 - PRODUCTS OR SERVICES (if
                                                applicable) <br style="box-sizing:border-box">
                                        </em>Certain products or services may be available exclusively online through
                                        the website. These
                                        products or
                                        ...
                                        that
                                        appear at the store. We cannot guarantee that your computer monitor's display of
                                        any color will be
                                        accurate.
                                        ...
                                        <br style="box-sizing:border-box">
                                        <br style="box-sizing:border-box">
                                        <em style="box-sizing:border-box">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT
                                                INFORMATION <br style="box-sizing:border-box">
                                        </em>We reserve the right to refuse any order you place with us. We may, in our
                                        sole discretion,
                                        limit or
                                        ...
                                        <br style="box-sizing:border-box">
                                        <br style="box-sizing:border-box">
                                        <em style="box-sizing:border-box">SECTION 7 - OPTIONAL TOOLS <br
                                                        style="box-sizing:border-box">
                                        </em>We may provide you with access to third-party tools over which we neither
                                        ...
                                        <br style="box-sizing:border-box">
                                        <br style="box-sizing:border-box">
                                        <em style="box-sizing:border-box">SECTION 8 - THIRD-PARTY LINKS <br
                                                        style="box-sizing:border-box">
                                        </em>Certain content, products and services available via our Service may
                                        ...
                                        <br style="box-sizing:border-box">
                                        <br style="box-sizing:border-box">
                                        <em style="box-sizing:border-box">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER
                                                SUBMISSIONS <br style="box-sizing:border-box">
                                        </em>If, at our request, you send certain specific submissions (for example
                                        contest entries) or
                                        without a
                                        ...
                                        use in any medium any
                                        comments
                                        that you forward to us. We are and shall be under no obligation (1) to maintain
                                        any comments in
                                        confidence;
                                        ...
                                        mislead us or
                                        third-parties as
                                        to the origin of any comments. You are solely responsible for any comments you
                                        make and their
                                        accuracy. We
                                        take no responsibility and assume no liability for any comments posted by you or
                                        any third-party.
                                        ...
                                        <br style="box-sizing:border-box">
                                        <br style="box-sizing:border-box">
                                        <em style="box-sizing:border-box">SECTION 10 - PERSONAL INFORMATION <br
                                                        style="box-sizing:border-box">
                                        </em>Your submission of personal information through the store is governed by
                                        our Privacy Policy. To
                                        view
                                        our Privacy Policy.
                                        ...
                                        <br style="box-sizing:border-box">
                                        <br style="box-sizing:border-box">
                                        <em style="box-sizing:border-box">SECTION 11 - ERRORS, INACCURACIES AND
                                                OMISSIONS <br style="box-sizing:border-box">
                                        </em>Occasionally there may be information on our site or in the Service that
                                        ...
                                        or on
                                        any related website is inaccurate at any time without prior notice (including
                                        after you have
                                        submitted your
                                        order).
                                        ...
                                        <br style="box-sizing:border-box">
                                        <br style="box-sizing:border-box">
                                        <em style="box-sizing:border-box">SECTION 12 - PROHIBITED USES <br
                                                        style="box-sizing:border-box">
                                        </em>In addition to other prohibitions as set forth in the Terms of Service, you
                                        are prohibited from
                                        using
                                        the site or its content: (a) for any unlawful purpose; (b) to solicit others to
                                        perform or
                                        participate in
                                        ...
                                        website, other
                                        websites, or
                                        the Internet; (h) to collect or track the personal information of others; (i) to
                                        spam, phish, pharm,
                                        ...
                                        <br style="box-sizing:border-box">
                                        <em style="box-sizing:border-box"><br style="box-sizing:border-box">
                                                SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY



                                        </em><br style="box-sizing:border-box">
                                        ...
                                        your sole risk. The
                                        service and
                                        all products and services delivered to you through the service are (except as
                                        expressly stated by
                                        us)
                                        ...
                                        In no case shall sadfasdfsdfsd, our directors, officers, employees, affiliates,
                                        agents, contractors,
                                        ...
                                        claim related in any way
                                        to your
                                        use of the service or any product, including, but not limited to, any errors or
                                        omissions in any
                                        content, or
                                        any loss or damage of any kind incurred as a result of the use of the service
                                        or any content (or product) posted, transmitted, or otherwise made available via
                                        the service, even
                                        if
                                        ...
                                        <br style="box-sizing:border-box">
                                        <br style="box-sizing:border-box">
                                        <em style="box-sizing:border-box">SECTION 14 - INDEMNIFICATION <br
                                                        style="box-sizing:border-box">
                                        </em>You agree to indemnify, defend and hold harmless sadfasdfsdfsd
                                        &amp;nsbp;and our parent,
                                        subsidiaries,
                                        ...
                                        <br style="box-sizing:border-box">
                                        <br style="box-sizing:border-box">
                                        <em style="box-sizing:border-box">SECTION 15 - SEVERABILITY <br
                                                        style="box-sizing:border-box">
                                        </em>In the event that any provision of these Terms of Service is determined to
                                        be unlawful, void or
                                        ...
                                        <br style="box-sizing:border-box">
                                        <br style="box-sizing:border-box">
                                        <em style="box-sizing:border-box">SECTION 16 - TERMINATION <br
                                                        style="box-sizing:border-box">
                                        </em>The obligations and liabilities of the parties incurred prior to the
                                        ...
                                        <br style="box-sizing:border-box">
                                        <br style="box-sizing:border-box">
                                        <em style="box-sizing:border-box">SECTION 17 - ENTIRE AGREEMENT <br
                                                        style="box-sizing:border-box">
                                        </em>The failure of us to exercise or enforce any right or provision of these
                                        ...
                                        <br style="box-sizing:border-box">
                                        <br style="box-sizing:border-box">
                                        <em style="box-sizing:border-box">SECTION 18 - GOVERNING LAW <br
                                                        style="box-sizing:border-box">
                                        </em>These Terms of Service and any separate agreements whereby we provide you
                                        Services shall be
                                        governed by
                                        ...
                                        <br style="box-sizing:border-box">
                                        <br style="box-sizing:border-box">
                                        <em style="box-sizing:border-box">SECTION 19 - CHANGES TO TERMS OF SERVICE <br
                                                        style="box-sizing:border-box">
                                        </em>You can review the most current version of the Terms of Service at any time
                                        at this page.
                                        ...
                                        Questions about the Terms of Service should be sent to us at <a
                                                style="box-sizing:border-box;color:#479ccf;text-decoration:none"></a>.
                                </p>
                        </span></td>
