...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
        <div class="x_title">
            <h2>All Quotation Requests <a class="btn btn-primary"
                    href="{{route('dashboard.supplier.quotation.create')}}">Request Quote</a>
            </h2>
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting_asc" tabindex="0"
                                                    ...
                                                    aria-label="First name: activate to sort column descending">Title
                                                </th>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                                    ...
                                                    aria-label="E-mail: activate to sort column ascending">Status</th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                                    rowspan="1" colspan="1" style="width: 176px;"
                                                    aria-label="Position: activate to sort column ascending">Added Date
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                                    rowspan="1" colspan="1" style="width: 176px;"
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <a class="btn"
                                                            href="{{route('dashboard.supplier.quotation.edit',$item->id)}}">
                                                            <i class="fa fa-edit"></i> Recevied
                                                        </a>
                                                        <a class="btn"
                                                            href="{{route('dashboard.supplier.quotation.show',$item->id)}}">
                                                            <i class="fa fa-edit"></i> Show
                                                        </a>

                                                        <form method="POST"
                                                            action="{{route('dashboard.supplier.quotation.destroy',$item->id)}}">
                                                            @csrf
                                                            @method('delete')
