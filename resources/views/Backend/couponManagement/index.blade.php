...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
        <div class="x_title">
            <h2>All Coupons <a class="btn btn-primary" href="{{route('dashboard.coupon.create')}}">Add Coupon</a>
            </h2>
                                    ...
                                    <table id="datatable-responsive"
                                        ...
                                        <thead>
                                            <tr role="row">
                                                {{--                                 <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                                    ...
                                                    aria-label="User Name: activate to sort column ascending">Image

                                                </th> --}}
                                                <th class="sorting_asc" tabindex="0"
                                                    aria-controls="datatable-responsive" rowspan="1" colspan="1"
                                                    style="width: 81px;" aria-sort="ascending"
                                                    aria-label="First name: activate to sort column descending">coupon
                                                    Name
                                                </th>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                                    ...
                                                    aria-label="E-mail: activate to sort column ascending">coupon Amount
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                                    rowspan="1" colspan="1" style="width: 176px;"
                                                    aria-label="Position: activate to sort column ascending">coupon
                                                    Status
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                                    rowspan="1" colspan="1" style="width: 176px;"
                                                    aria-label="Options: activate to sort column ascending">availability
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                                    rowspan="1" colspan="1" style="width: 176px;"
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                <input class="servicedeleteval_id" type="hidden" name=""
                                                    value="{{$item->id}}">
                                                {{-- <td tabindex="0" class="sorting_1">
                                                    <img src="{{url('upload/product/',$product->image)}}" class=""
                                                alt="" width="30px" title="Change the avatar">
                                                </td> --}}
                                                <td>{{$item->name}}</td>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        {{-- btn-app --}}
                                                        <a class="btn"
                                                            href="{{route('dashboard.coupon.edit',$item->id)}}">
                                                            <i class="fa fa-edit"></i> Edit
                                                        </a>


                                                        <a href="/dashboard/coupon/delete/{{$item->id}}"
                                                            class="btn servicedeletebtn delete-confirm"><i
                                                                class="fa fa-warning"></i>Delete</a>
                                                        {{--   <button type="submit" class="btn servicedeletebtn"><i
                                                                    class="fa fa-warning"></i>Delete</button> --}}
