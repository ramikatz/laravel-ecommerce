                ...
                <form action="{{route('dashboard.coupon.store')}}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-10 col-sm-10 ">
                            <input type="text" name="name" placeholder="Coupon Name" id="product_sub"
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-10 col-sm-10 ">
                            <input type="text" name="coupon_code" placeholder="Coupon Code" id="product_sub"
                                required="required" class="form-control">
                        </div>
                    </div>
                    <div class="item form-group">
                        ...
                        <div class="col-md-10 col-sm-10 ">
                            <input type="text" name="amount" placeholder="Amout" id="purchase_price" required="required"
                                class="form-control">
                        </div>
                    </div>
                    <div class="item form-group">
                        ...
                        <div class="col-md-10 col-sm-10 ">
                            <input type="text" name="availability" placeholder="Availability" id="purchase_price"
                                required="required" class="form-control">
                        </div>
                    </div>
                    <div class="item form-group">
