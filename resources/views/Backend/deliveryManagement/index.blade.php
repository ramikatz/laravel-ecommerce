                                ...
                                <div class="col-sm-12">
                                    <table id="datatable-responsive"
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting_asc" tabindex="0"
                                                    ...
                                                    aria-label="First name: activate to sort column descending">Location
                                                </th>
                                                ...
                                                <th class="sorting_asc" tabindex="0"
                                                    aria-controls="datatable-responsive" rowspan="1" colspan="1"
                                                    style="width: 81px;" aria-sort="ascending"
                                                    aria-label="First name: activate to sort column descending">Note
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row"
                                                class="odd  <?= $order->deliveryperson_id === '' ? 'bg-success text-white' : '' ?>">
                                                <td tabindex="0" class="sorting_1">
                                                    {{$order->order_number}}
                                                </td>

                                                <td>{{$order->owneruser->address->billing_state}}</td>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <a class="btn"
                                                            href="{{route('dashboard.delivery.edit',$order->id)}}">
