...
<div class="col-md-9">
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br>
                <form action="{{route('dashboard.shipping.store')}}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-10 col-sm-10 ">
                            <input type="text" name="location" id="product_sub" required="required"
                                class="form-control ">
                        </div>
                    </div>
                    {{--   <div class="item form-group">
                        <label class="col-form-label col-md-2 col-sm-2" for="last-name">charge<span
                                class="required">*</span>
                        </label>
                        <div class="col-md-10 col-sm-10 ">
                            <input type="text" name="charge" id=" product_sub" required="required" class="form-control">
                        </div>
                    </div> --}}
