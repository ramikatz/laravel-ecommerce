...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
        <div class="x_title">
            <h2>All Districts <a class="btn btn-primary" href="{{route('dashboard.shipping.create')}}">Add District</a>
            </h2>
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting_asc" tabindex="0"
                                                    ...
                                                    aria-label="First name: activate to sort column descending">District
                                                    Name
                                                </th>
                                                ...
                                                {{--  <th class="sorting_asc" tabindex="0"
                                                    aria-controls="datatable-responsive" rowspan="1" colspan="1"
                                                    style="width: 81px;" aria-sort="ascending"
                                                    aria-label="First name: activate to sort column descending">Charging
                                                    Amout
                                                </th> --}}
                                                {{-- <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                                    rowspan="1" colspan="1" style="width: 166px;"
                                                    aria-label="E-mail: activate to sort column ascending">Quantity</th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    <div class="row">
                                                        {{-- btn-app --}}
                                                        <a class="btn"
                                                            href="{{route('dashboard.shipping.edit',$item->id)}}">
                                                            <i class="fa fa-edit"></i> Edit
                                                        </a>

                                                        <form method="POST"
                                                            action="{{route('dashboard.shipping.destroy',$item->id)}}">
                                                            @csrf
                                                            @method('delete')
                                                            <button type="submit" class="btn servicedeletebtn"><i
                                                                    class="fa fa-warning"></i>Delete</button>
                                                            {{-- <button type="button" class="btn servicedeletebtn"><i
                                                                class="fa fa-warning"></i>Delete</button> --}}
                                                        </form>
                                                    </div>
