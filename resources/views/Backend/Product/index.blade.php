...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
        <div class="x_title">
            <h2>All Products <a class="btn btn-primary" href="{{route('dashboard.product.create')}}">Add Product</a>
            </h2>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('frontend.product_view',$product->slug)}}">
                                                        View Product
                                                    </a>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="badge badge badge-success">{{$item->name}}</span>
                                                    @endforeach
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-2">{{ $products->links() }}</div>
                                    </div>
