                ...
                <form action="{{route('dashboard.product.store')}}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-10 col-sm-10 ">
                            <input type="text" name="product_title" id="product_sub" required="required"
                                class="form-control ">
                        </div>
                    </div>
                    <div class="item form-group">
                        ...
                        <div class="col-md-10 col-sm-10 ">
                            <input type="text" name="product_sub" id="product_sub" required="required"
                                class="form-control">
                        </div>
                    </div>
                    <div class="item form-group">
                        ...
                        <div class="col-md-10 col-sm-10 ">
                            <input type="text" name="purchase_price" id="purchase_price" required="required"
                                class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="regular_price" class="form-control" id="inputEmail4"
                                placeholder="Type Regular Price">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputPassword4">Sale Price</label>
                            <input type="text" name="sale_price" class="form-control" id="inputPassword4"
    ...
    <div class="col-md-12 col-sm-12 ">
        ...
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br>
                    <textarea id="content" name="content" placeholder="Device Specification"></textarea>
                </div>
            </div>
        </div>
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br>
                    <textarea id="description" name="description" placeholder="Device Description"></textarea>
                </div>
            </div>
        </div>
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-10 col-sm-10 ">
                            <input type="text" name="keywords" id="first-name" required="required"
                                class="form-control ">
                        </div>
                    </div>
                    <div class="item form-group">
        ...
        <div class="x_content">
            <div class="form-group row">
                <div class="form-group col-md-12">
                    ...
                    <input type="text" name="quantity" class="form-control" id="inputEmail4"
