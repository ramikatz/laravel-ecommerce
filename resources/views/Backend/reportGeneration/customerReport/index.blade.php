        ...
        <div class="x_content">
            <div class="row">
                <div class="col-md-12 daterange">
                    ...
                    <form action="{{route('dashboard.report.customer.generate')}}" method="POST">
                        @csrf
                    ...
                    <table class="table table-striped ">
                        <thead class="table-dark">
                            <tr>
                                <th>User Name</th>
                                <th>Email</th>
                                <th style="width: 46%;">order details</th>
                                <th>Joint At</th>
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td>
                                    ...
                                    <span class="badge badge badge-success">{{$order->order_number}}</span>
                                    @endforeach
                                </td>
                                <td tabindex="0" class="sorting_1">
                                    {{$item->created_at}}
