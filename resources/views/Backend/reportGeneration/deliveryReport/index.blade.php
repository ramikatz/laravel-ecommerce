        ...
        <div class="x_content">
            <div class="row">
                <div class="col-md-12 daterange">
                    ...
                    <form action="{{route('dashboard.report.delivery.filter')}}" method="POST">
                        @csrf
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <div class="col-md-11 xdisplay_inputx form-group row has-feedback">
                                                <input type="text" name="start_date" @isset($rstart_date)
                                                    value="{{$rstart_date}}" @endisset
                                                    class="form-control has-feedback-left" id="single_cal2"
                                                    placeholder="" aria-describedby="inputSuccess2Status2">
                                                {{--  <input type="hidden" name="end_date" value="{{$rstart_date}}">
                                                --}}
                            ...
                            <div class="col-md-4">
                                <fieldset>
                                    <div class="control-group">
                                        <div class="controls">
                                            <div class="col-md-11 xdisplay_inputx form-group row has-feedback">
                                                <input type="text" name="end_date" @isset($rend_date)
                                                    value="{{$rend_date}}" @endisset
                                                    class="form-control has-feedback-left" id="single_cal3"
                                                    placeholder="" aria-describedby="inputSuccess2Status3">
                                                <span class="fa fa-calendar-o form-control-feedback left"
                                                    aria-hidden="true"></span>
                                                <span id="inputSuccess2Status3" class="sr-only">(success)</span>
                                                {{--   <input type="hidden" name="end_date" value="{{$rend_date}}"> --}}
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
